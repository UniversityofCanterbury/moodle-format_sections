...
/**
 * Sections course format related unit tests.
 *
 * @package    format_sections
 * @copyright  2015 Marina Glancy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_sections_test extends \advanced_testcase {

    /**
     * Tests for format_sections::get_section_name method with default section names.
     *
     * @return void
     */
    public function test_get_section_name() {
        ...
        $numsections = 5;
        $course = $generator->create_course(['numsections' => $numsections, 'format' => 'sections'],
            ['createsections' => true]);
    ...
    /**
     * Tests for format_sections::get_section_name method with modified section names.
     *
     * @return void
     */
    ...
    /**
     * Tests for format_sections::get_default_section_name.
     *
     * @return void
     */
    public function test_get_default_section_name() {
        ...
        foreach ($coursesections as $section) {
            if ($section->section == 0) {
                $sectionname = get_string('section0name', 'format_sections');
                $this->assertEquals($sectionname, $courseformat->get_default_section_name($section));
            } else {
                $sectionname = get_string('sectionname', 'format_sections') . ' ' . $section->section;
                $this->assertEquals($sectionname, $courseformat->get_default_section_name($section));
            }
        }
    }
    ...
    public function test_update_inplace_editable() {
        ...
        $this->setUser($user);
        $course = $this->getDataGenerator()->create_course(['numsections' => 5, 'format' => 'sections'],
            ['createsections' => true]);
        $section = $DB->get_record('course_sections', ['course' => $course->id, 'section' => 2]);

        // Call webservice without necessary permissions.
        try {
            \core_external::update_inplace_editable('format_sections', 'sectionname', $section->id, 'New section name');
        ...
        $res = \core_external::update_inplace_editable('format_sections', 'sectionname', $section->id, 'New section name');
    ...
    public function test_inplace_editable() {
        ...
        // Call callback format_sections_inplace_editable() directly.
        $tmpl = component_callback('format_sections', 'inplace_editable', ['sectionname', $section->id, 'Rename me again']);
    ...
    public function test_default_course_enddate() {
        ...
        $params = ['format' => 'sections', 'numsections' => 5, 'startdate' => 1445644800];
    ...
    public function test_get_view_url() {
        ...
        $generator = $this->getDataGenerator();
        $course1 = $generator->create_course(['format' => 'sections']);
